...
import { Menu, X, Bell, LogOut, Search, LayoutDashboard, Users, BookOpen, CheckSquare, BarChart2, Target, Trophy, Star, ChevronDown, Sparkles, Calendar, FolderSync, CheckCircle2 } from 'lucide-react';
            ...
            <div className="flex-1 flex flex-col min-w-0 relative z-10">
                ...
                <header className="h-16 flex items-center justify-between px-6 border-b border-white/[0.08] bg-white/[0.03] backdrop-blur-md flex-shrink-0">
                    ...
                    <div className="flex items-center gap-3 ml-auto">
                        ...
                        {/* Notifications */}
                        <button className="relative p-2 text-white/50 hover:text-white hover:bg-white/10 rounded-xl transition-all">
                            <Bell size={18} />
