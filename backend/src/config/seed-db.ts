...
import('pg').then(async ({ Pool }) => {
    ...
    async function seedDatabase() {
        try {
            ...
            // 1. Users
            const testUsers = [
                { email: 'student1@example.com', password: 'Student@123', role: 'STUDENT', prn_no: 'PRN001', roll_no: 'CS001', batch_year: 2024 },
                { email: 'student2@example.com', password: 'Student@123', role: 'STUDENT', prn_no: 'PRN002', roll_no: 'CS002', batch_year: 2024 },
                { email: 'student3@example.com', password: 'Student@123', role: 'STUDENT', prn_no: 'PRN003', roll_no: 'CS003', batch_year: 2024 },
                { email: 'guide1@example.com', password: 'Guide@123', role: 'GUIDE', expertise_tags: ['AI', 'Machine Learning', 'Data Science'] },
                { email: 'guide2@example.com', password: 'Guide@123', role: 'GUIDE', expertise_tags: ['Web Development', 'React', 'Node.js'] },
                { email: 'coordinator@example.com', password: 'Coordinator@123', role: 'COORDINATOR' },
                { email: 'committee@example.com', password: 'Committee@123', role: 'COMMITTEE' }
            ];
